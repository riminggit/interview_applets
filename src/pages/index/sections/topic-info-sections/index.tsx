        ...
        <View className='header-content'>
            ...
            <View className='topic-info-card'>
                <View className='user-topic-info-card'>
                    <UserTopicInfoCard echartsId="echarts" point={30.3} title='未看题目' icon={noreadIcon} topicNum={300} btnTitle='随机套题' />
                </View>
                <View className='user-topic-info-card'>
                    <UserTopicInfoCard echartsId="echarts1" point={60} title='错题重刷' icon={mistakeTopicIcon} topicNum={20} btnTitle='随机选题' btnBackground='#F56C6C' />
                </View>
            </View>
        </View>
    );
