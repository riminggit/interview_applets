                        ...
                        globalStore.loginStatus ?
                            <View className='user-info'>
                                ...
                                <View className='level-info'>
                                    <View className='designation' style={{ background: globalStore.userLevelColor }}>
                                        <Text className='designation-font' style={{ color: isDarkColor(globalStore.userLevelColor) ? '#fff' : '#616367' }}>初级工程师</Text>
                                    </View>
                                    <AtProgress className='level-bar' percent={25} color={globalStore.userLevelColor} isHidePercent={false} strokeWidth={8} />
                                </View>
                            ...
                            : <View className='user-info'>
                                <View onClick={() => { toLogin() }}><Text>登录 / 注册</Text></View>
